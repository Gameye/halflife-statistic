Feature: Get team score from log-files
    ...
    Examples:
        ...
        | tf2-6v6test-payload-v2.log | 308  | Blue   | Red    | 0       | 0       | 
        | tf2-6v6test-payload-v2.log | 318  | Blue   | Red    | 1       | 0       | 
        | tf2-6v6test-payload-v2.log | 321  | Blue   | Red    | 2       | 0       | 
        | tf2-6v6test-payload-v2.log | 323  | Blue   | Red    | 3       | 0       |
        | tf2-6v6test-payload-v2.log | 343  | Blue   | Red    | 4       | 0       |
        | tf2-6v6test-payload-v2.log | 354  | Blue   | Red    | 0       | 4       |
        | tf2-6v6test-payload-v2.log | 367  | Blue   | Red    | 1       | 4       | 
        | tf2-6v6test-payload-v2.log | 5804 | Blue   | Red    | 1       | 4       | 
        ...
        | tf2-6v6test-payload-v6.log | 342  | Blue   | Red    | 3       | 4       |
